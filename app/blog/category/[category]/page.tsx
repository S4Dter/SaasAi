...
import { getBlogPostsByCategory, getAllCategories } from '@/data/blog-posts';
...
export async function generateMetadata({ params }: { params: { category: string } }): Promise<Metadata> {
  ...
  return {
    title: `Articles sur ${category} - Blog`,
    description: `Découvrez tous nos articles sur ${category} et les dernières tendances en IA.`,
  };
}
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Catégorie : {category}</h1>
